...
import { socket } from "../service"; // ✅ using shared socket
...
export default function VideoCall() {
  ...
  useEffect(() => {
    ...
    const sock = socket; // ✅ use shared socket
    ...
    const init = async () => {
      try {
        ...
        sock.on("room_ready", ({ isCaller: caller, type }) => {
          ...
          setStatus(caller ? "Waiting..." : "Joining...");
        });
  ...
  return (
    <div className="w-full h-screen bg-black relative flex items-center justify-center">
      ...
      <div
        className={`absolute right-6 top-24 w-32 h-40 bg-gray-900 rounded-xl overflow-hidden z-10 ${
      ...
      <div className="absolute bottom-6 flex gap-4 bg-gray-700/50 px-6 py-3 rounded-full">
