...
// ================= SOCKET =================
// ✅ NOTE: This singleton socket is for general app use (notifications, responder join, etc.)
// The VideoCall component uses its OWN separate socket (forceNew: true) to avoid conflicts.
export const socket = io(SOCKET_URL, {
  withCredentials: true,
});
